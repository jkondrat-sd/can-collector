...
public:
    ...
    // Telemetry functions
    // virtual void log(uint16_t pid, uint8_t values[], uint8_t count, const char* telemetryName);
    // virtual void log(uint16_t pid, uint16_t values[], uint8_t count, const char* telemetryName);
    // virtual void log(uint16_t pid, uint32_t values[], uint8_t count, const char* telemetryName);
    // virtual void log(uint16_t pid, int32_t values[], uint8_t count, const char* telemetryName);
    // virtual void log(uint16_t pid, float values[], uint8_t count, const char* fmt = "%f", const char* telemetryName = "telemetria");
